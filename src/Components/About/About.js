            ...
            <div className="w-full md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-78">
              <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-pink-500">
                ...
                <blockquote className="relative p-4 mb-4">
                  <h4 className="text-xl font-bold text-white">Shift us</h4>
                ...
                <div className="w-full md:w-6/12 px-4">
                  <div className="relative flex flex-col mt-4">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      <h6 className="text-xl mb-1 font-semibold">Emma Watson</h6>
                      <p className="mb-4 text-indigo-500">CEO, Shiftus</p>
                    </div>
                  </div>
                  <div className="relative flex flex-col min-w-0">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      <h6 className="text-xl mb-1 font-semibold">Harry Potter</h6>
                      <p className="mb-4 text-indigo-500">Marketing head</p>
                    </div>
                  </div>
                </div>
                <div className="w-full md:w-6/12 px-4">
                  <div className="relative flex flex-col min-w-0 mt-4">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      <h6 className="text-xl mb-1 font-semibold">Ronald Wiesely</h6>
                  ...
                  <div className="relative flex flex-col min-w-0">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      <h6 className="text-xl mb-1 font-semibold">Severus Snape</h6>
                      <p className="mb-4 text-indigo-500">Advisor</p>
                    </div>
                  </div>
                </div>
              </div>
