...
import footerImg from "../../images/header_images/icons8-delivery-50.png";

const Footer = () => {
  return (
    <div>
      <footer className="px-4 divide-y bg-indigo-400 font-bold dark:bg-coolGray-800 dark:text-coolGray-100">
        ...
        <div className="py-6 text-sm text-center dark:text-coolGray-400">
          All rights reserved © Shiftus Company
        </div>
      </footer>
    </div>
  );
